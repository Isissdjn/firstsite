...
document.addEventListener("DOMContentLoaded", function() {
  // Récupérez tous les boutons "Obtenir"
  ...
  obtenirButtons.forEach(function(button) {
      button.addEventListener('click', function(event) {
          ...
          // Récupérez l'identifiant unique de l'article correspondant
          var articleId = button.closest('.team-classic').getAttribute('data-id');

          // Récupérez le champ "Message" du formulaire
          var messageField = document.getElementById('contact-message-2');

          // Remplissez le champ "Message" avec le message souhaité
